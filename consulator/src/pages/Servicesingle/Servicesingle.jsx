          ...
          <div className="row">
            <div className="col-xl-8">
              <div className="content-img">
                <img
                  src="http://consultar-react.wpocean.com/static/media/1.9b34b36d.jpg"
                  alt="img"
                />
              </div>
            </div>
            ...
            <div className="col-xl-8">
              <div className="service-content-des">
                <p>How To Creat a Great Company With Strategy and Planning</p>
                <h2>
            ...
            <div className="col-xl-4">
              <div className="newsletter-widget">
                ...
                <h5>
                  By signing up you agree to our <Link>Privecy Policy</Link>
                </h5>
              </div>
            </div>
          </div>
