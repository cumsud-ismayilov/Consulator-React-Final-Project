...
import "../BlogLeftSidebar/BlogLeftSidebar.scss";
import {
  BiLogoFacebook,
  BiLogoTwitter,
  BiLogoLinkedin,
          ...
          <div className="col-xl-4">
              ...
              <div className="category-widget">
                ...
                <ul className="category-ul">
                  <li className="category-li">Blockchain Consulting <h1>5</h1></li>
                  <li className="category-li">Commodity Traders <h1>7</h1></li>
                  <li className="category-li">Financial Planning <h1>3</h1></li>
                  <li className="category-li">Investment Consulting <h1>6</h1></li>
                  <li className="category-li">Online Banking Consulting <h1>2</h1></li>
                  <li className="category-li">Personal Consulting Advice <h1>8</h1></li>
                </ul>
              </div>
            ...
            <div className="col-xl-8">
              ...
              <div className="blog-pagination">
                <h6 className="pagination1"><Link to="/blogrightsidebar"><AiOutlineLeft size="21"/></Link></h6>
                <h6 className="pagination2"><Link to="/blogrightsidebar">1</Link></h6>
                <h6 className="pagination1"><Link to="/blogrightsidebar">2</Link></h6>
                <h6 className="pagination1"><Link to="/blogrightsidebar">3</Link></h6>
                <h6 className="pagination1"><Link to="/blogrightsidebar"><AiOutlineRight size="21"/></Link></h6>
              </div>
            </div>
          </div>
        </div>
